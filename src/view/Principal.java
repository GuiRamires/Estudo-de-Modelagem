...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		btnUsuarios.setIcon(new ImageIcon(Principal.class.getResource("/img/people.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(Principal.class.getResource("/img/user (1).png")));
		...
		btnNewButton_1_1.setIcon(new ImageIcon(Principal.class.getResource("/img/group.png")));
		...
		btnNewButton_2.setIcon(new ImageIcon(Principal.class.getResource("/img/boxbox.png")));
		...
		btnNewButton_3.setIcon(new ImageIcon(Principal.class.getResource("/img/128money.png")));
		...
		btnRelatorios.setIcon(new ImageIcon(Principal.class.getResource("/img/paper.png")));
		...
		btnNewButton_2_1.setIcon(new ImageIcon(Principal.class.getResource("/img/128config.png")));
		...
		btnNewButton_1_1_1.setIcon(new ImageIcon(Principal.class.getResource("/img/information.png")));
