...
public class Usuarios extends JDialog {
	...
	public Usuarios() {
		...
		btnPesquisar.setIcon(new ImageIcon(Usuarios.class.getResource("/img/01-magnifying-glass-1-16.png")));
		...
		btnAdicionar.setBounds(236, 196, 64, 64);
		...
		btnAlterar.setIcon(new ImageIcon(Usuarios.class.getResource("/img/back.png")));
		btnAlterar.setToolTipText("Alterar");
		btnAlterar.setContentAreaFilled(false);
		btnAlterar.setBorderPainted(false);
		btnAlterar.setBounds(322, 196, 64, 64);
		...
		btnExcluir.setIcon(new ImageIcon(Usuarios.class.getResource("/img/cacelar.png")));
		btnExcluir.setToolTipText("Excluir");
		btnExcluir.setContentAreaFilled(false);
		btnExcluir.setBorderPainted(false);
		btnExcluir.setBounds(396, 196, 64, 64);
